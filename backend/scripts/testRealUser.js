...
async function testRealUser() {
    ...
    try {
        ...
        const userData = {
            ...
            role: 'student',
            guardianName: 'Real Test Guardian'
        };
        ...
        // Step 3: Test Redis endpoint with real user
        console.log('\n3️⃣ Testing Redis endpoint with real user...');

        const applicationData = {
            personalDetails: {
                fullName: 'Real Test Student',
                fathersName: 'Real Test Father',
                mothersName: 'Real Test Mother',
            ...
            contactDetails: {
                ...
                email: 'realteststudent@example.com',
                permanentAddress: {
                    street: 'Real Test Street',
                    city: 'Real Test City',
                    state: 'Odisha',
                    pincode: '751001',
                    country: 'India'
