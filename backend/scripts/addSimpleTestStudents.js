...
const addSimpleTestStudents = async () => {
    try {
        // Connect to MongoDB
        ...
        for (const studentData of testStudents) {
            ...
            // Create student application directly
            const application = new StudentApplication({
                studentId: user._id, // Use user ID as student ID for simplicity
...
if (require.main === module) {
    addSimpleTestStudents();
}

module.exports = addSimpleTestStudents;
