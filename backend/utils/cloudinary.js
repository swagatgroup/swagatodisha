...
class CloudinaryService {
    ...
    static async processStudentDocuments(documents) {
        ...
        console.log('Processing student documents:', Object.keys(documents));
        ...
        for (const type of documentTypes) {
            if (documents[type]) {
                ...
                console.log(`No ${type} document provided`);
            }
        }

        console.log('Final processed documents:', Object.keys(processedDocuments));
