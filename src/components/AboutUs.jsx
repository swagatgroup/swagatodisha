...
const AboutUs = () => {
    ...
    return (
        <section 
            ref={aboutRef}
            id="about-us" 
            className="relative py-20 bg-gradient-to-br from-white to-gray-50 overflow-hidden"
        >
            {/* Parallax Background Elements */}
            <div className="absolute inset-0">
                <div className={`absolute top-20 left-10 w-64 h-64 bg-gradient-to-r from-purple-100 to-blue-100 rounded-full blur-3xl transition-all duration-1000 ${
                    isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-50'
                }`}></div>
                <div className={`absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full blur-3xl transition-all duration-1000 delay-300 ${
                    isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-50'
                }`}></div>
                
                {/* Floating geometric shapes */}
                <div className={`absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-r from-purple-400/30 to-blue-400/30 rounded-lg blur-xl transition-all duration-1000 delay-500 ${
                    isVisible ? 'animate-float-slow opacity-100' : 'opacity-0'
                }`}></div>
                <div className={`absolute bottom-1/3 left-1/4 w-20 h-20 bg-gradient-to-r from-blue-400/30 to-green-400/30 rounded-full blur-xl transition-all duration-1000 delay-700 ${
                    isVisible ? 'animate-float-medium opacity-100' : 'opacity-0'
                }`}></div>
            </div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className={`text-center mb-20 transition-all duration-1000 ${
                    ...
                    <div className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl mb-6 shadow-2xl transition-all duration-1000 delay-300 ${
                        isVisible ? 'scale-100 rotate-0' : 'scale-0 rotate-180'
                    }`}>
                        <i className="fa-solid fa-university text-white text-3xl"></i>
                    </div>

                    <h2 className={`text-5xl md:text-7xl font-bold text-gray-800 mb-6 transition-all duration-1000 delay-500 ${
                        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                    }`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className={`space-y-8 transition-all duration-1000 delay-900 ${
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className={`text-center p-6 bg-white rounded-2xl shadow-lg border border-gray-100 transition-all duration-700 delay-1100 hover:scale-105 hover:shadow-xl ${
                                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                                }`}>
                                    <div className="text-3xl font-bold text-purple-600 mb-2">25+</div>
                                    <div className="text-sm text-gray-600">Years of Excellence</div>
                                </div>
                                <div className={`text-center p-6 bg-white rounded-2xl shadow-lg border border-gray-100 transition-all duration-700 delay-1300 hover:scale-105 hover:shadow-xl ${
                                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                                }`}>
                        ...
                        <div className={`relative transition-all duration-1000 delay-1100 ${
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                {features.map((feature, index) => (
                                    <div
                                        key={index}
                                        className={`relative p-6 bg-white rounded-2xl shadow-lg border border-gray-100 transition-all duration-500 cursor-pointer group hover:scale-105 hover:shadow-xl ${
                                    ...
                                    >
                                        ...
                                        {/* Icon */}
                                        <div className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center mb-4 transition-all duration-500 group-hover:scale-110 ${
                                            activeFeature === index ? 'animate-pulse-slow' : ''
                                        }`}>
                            ...
                            <div className={`absolute -top-8 -right-8 w-32 h-32 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full flex items-center justify-center text-white shadow-2xl transition-all duration-1000 delay-1500 ${
                ...
                {/* Call to Action */}
                <div className={`text-center mt-20 transition-all duration-1000 delay-1700 ${
                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}>
