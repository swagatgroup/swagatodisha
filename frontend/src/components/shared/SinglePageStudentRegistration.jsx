...
const SinglePageStudentRegistration = ({
                ...
                >
                    <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                        <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                            <span className="bg-[#F0E6FA] dark:bg-[#231A2E] text-[#4A1D7A] dark:text-[#C084FC] rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">7</span>
                            Generate PDF
                        </h3>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
                        <div className="mb-4">
                            <div className="w-16 h-16 bg-[#F0E6FA] dark:bg-[#231A2E] rounded-full flex items-center justify-center mx-auto mb-4">
                                <svg className="w-8 h-8 text-[#4A1D7A] dark:text-[#C084FC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <button
                                ...
                                className="px-6 py-3 bg-[#4A1D7A] text-white rounded-lg hover:bg-[#351458] disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                            >
                                {loading ? (
                                    <>
                ...
                >
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                                <div className="w-12 h-12 bg-[#F0E6FA] dark:bg-[#231A2E] rounded-full flex items-center justify-center mr-4">
                                    <svg className="w-6 h-6 text-[#4A1D7A] dark:text-[#C084FC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                </div>
                                <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 px-4 py-2 bg-[#4A1D7A] text-white rounded-lg hover:bg-[#351458] flex items-center justify-center"
                            >
                                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-8">
            ...
            >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4 flex items-center justify-between">
                    <div>
                        <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                            <span className="bg-[#F0E6FA] dark:bg-[#231A2E] text-[#4A1D7A] dark:text-[#C084FC] rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">1</span>
                    ...
                    {!registrationDataLocked && isEditingAccountData ? (
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-[#4A1D7A] dark:text-[#9B6FCC] border border-purple-300 dark:border-[#4A1D7A] rounded-lg hover:bg-[#F0E6FA] dark:hover:bg-purple-900/20 transition-colors"
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-lg ${
                                registrationDataLocked
                                    ...
                                    : 'border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent'
                            }`}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            style={{ textTransform: 'uppercase' }}
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent"
            ...
            >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4 flex items-center justify-between">
                    <div>
                        <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                            <span className="bg-[#F0E6FA] dark:bg-[#231A2E] text-[#4A1D7A] dark:text-[#C084FC] rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">2</span>
                            Contact Details
                            {registrationDataLocked && (
                                <span className="ml-2 inline-flex items-center gap-1 text-xs font-medium bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 px-2 py-0.5 rounded-full">
                                    <i className="fa-solid fa-lock text-[10px]"></i> From Registration
            ...
            >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                        <span className="bg-[#F0E6FA] dark:bg-[#231A2E] text-[#4A1D7A] dark:text-[#C084FC] rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">3</span>
                        Course Selection
                    </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            <i className="fa-solid fa-building mr-2 text-[#4A1D7A] dark:text-[#9B6FCC]"></i>
                            Campus *
                        </label>
                        <select
                ...
                {formData.courseDetails.selectedCollege && (() => {
                  ...
                  return (
                    <div className="md:col-span-3 mt-4 border border-gray-200 dark:border-gray-700 rounded-xl p-5 bg-gray-50 dark:bg-[#231A2E]/50">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                          <h4 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            <i className="fa-solid fa-graduation-cap text-[#4A1D7A]"></i>
                            Admission Type
                          </h4>
                          {isScSt && (
                          ...
                          <div className="flex items-center gap-6">
                            <label className="flex items-center gap-2 cursor-pointer">
                              <input
                                ...
                                className="w-4 h-4 text-[#4A1D7A] border-gray-300 focus:ring-[#4A1D7A]"
                              />
            ...
            {(formData.referralCode || referralMode) && (
                <motion.div
                    ...
                    className="space-y-6"
                >
                    <div className="bg-gray-50/50 dark:bg-[#231A2E]/30 p-6 rounded-xl border border-gray-100 dark:border-gray-700/50">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="p-2 bg-indigo-100 dark:bg-[#231A2E]/30 rounded-lg">
                                <i className="fa-solid fa-gift text-[#4A1D7A] dark:text-[#9B6FCC]"></i>
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <input
                                    ...
                                    disabled
                                    className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-100 dark:bg-[#231A2E] text-gray-500 dark:text-gray-300 font-mono tracking-widest cursor-not-allowed"
                                />
                            </div>
                        </div>
                    </div>
            ...
            >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                        <span className="bg-[#F0E6FA] dark:bg-[#231A2E] text-[#4A1D7A] dark:text-[#C084FC] rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">4</span>
                        Guardian Details
                    </h3>
            ...
            >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                        <span className="bg-[#F0E6FA] dark:bg-[#231A2E] text-[#4A1D7A] dark:text-[#C084FC] rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">5</span>
                        Document Upload
                    </h3>
            ...
            >
                <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                        <span className="bg-[#F0E6FA] dark:bg-[#231A2E] text-[#4A1D7A] dark:text-[#C084FC] rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mr-3">6</span>
    ...
    if (!allowRegistration && userRole !== 'superadmin') {
        return (
            <div className="max-w-4xl mx-auto p-6 mt-12 text-center">
                <div className="bg-white dark:bg-[#231A2E] rounded-lg shadow-lg p-12 border border-gray-200 dark:border-gray-700">
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white dark:bg-[#231A2E] rounded-lg shadow-lg p-6 space-y-8">
                {/* Form Content */}
                {renderForm()}
