...
const NotificationSystem = () => {
    ...
    const getNotificationColor = (type, isRead) => {
        ...
        const colors = {
            document_upload: 'bg-[#D0E8F0] border-l-blue-500',
        ...
        return colors[type] || 'bg-[#D0E8F0] border-l-blue-500';
    };
                    ...
                    <div className="flex space-x-2">
                        ...
                        {unreadCount > 0 && (
                            <button
                                ...
                                className="px-3 py-1 text-sm bg-[#387B95] text-white rounded-md hover:bg-[#1D4B5E]"
                            >
                                Mark All Read
                            </button>
                        )}
            ...
            {filteredNotifications.length > 5 && (
                <div className="p-4 border-t border-gray-200 text-center">
                    <button
                        ...
                        className="text-[#387B95] hover:text-[#1D4B5E] text-sm font-medium"
                    >
