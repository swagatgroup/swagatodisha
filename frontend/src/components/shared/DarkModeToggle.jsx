...
const DarkModeToggle = () => {
    ...
    return (
        <motion.button
            ...
            className="relative p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] transition-colors duration-200"
