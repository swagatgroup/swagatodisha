...
const UniversalStudentRegistration = ({
    ...
    const steps = [
        ...
        { id: 3, title: 'Course Selection', description: 'Choose your course and stream' },
        { id: 4, title: 'Guardian Details', description: 'Parent/Guardian information' },
        { id: 5, title: 'Document Upload', description: 'Upload required documents' },
        { id: 6, title: 'PDF Generation', description: 'Generate and preview application PDF' },
    ...
    const validateStep = (step) => {
        ...
        switch (step) {
            ...
            case 5: // Document Upload
                ...
                const requiredDocuments = ['passport_photo', 'aadhar_card', 'birth_certificate', 'marksheet_10th', 'marksheet_12th'];
                const missingDocuments = requiredDocuments.filter(doc => !formData.documents[doc]);
                if (missingDocuments.length > 0) {
                    newErrors['documents'] = `Please upload all required documents: ${missingDocuments.join(', ')}`;
                }
                break;
    ...
    const renderStepContent = () => {
        switch (currentStep) {
            ...
            case 6:
                return <ApplicationPDFGenerator formData={formData} application={application} />;
            case 7:
                return renderReview();
            default:
                return null;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    {errors['personalDetails.fathersName'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['personalDetails.fathersName']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            personalDetails: { ...prev.personalDetails, mothersName: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        placeholder="Enter mother's name"
                    />
                    {errors['personalDetails.mothersName'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['personalDetails.mothersName']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            personalDetails: { ...prev.personalDetails, aadharNumber: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            contactDetails: { ...prev.contactDetails, primaryPhone: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        placeholder="Enter 10-digit phone number"
                    />
                    {errors['contactDetails.primaryPhone'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['contactDetails.primaryPhone']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            contactDetails: { ...prev.contactDetails, whatsappNumber: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                ...
                <div className="md:col-span-2">
                    ...
                    {errors['contactDetails.email'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['contactDetails.email']}</p>
                    )}
                </div>
                ...
                <div className="md:col-span-2">
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...
                            contactDetails: {
                                ...prev.contactDetails,
                                permanentAddress: { ...prev.contactDetails.permanentAddress, street: e.target.value }
                            }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    ...
                    {errors['contactDetails.permanentAddress.street'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['contactDetails.permanentAddress.street']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...
                            contactDetails: {
                                ...prev.contactDetails,
                                permanentAddress: { ...prev.contactDetails.permanentAddress, city: e.target.value }
                            }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    ...
                    {errors['contactDetails.permanentAddress.city'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['contactDetails.permanentAddress.city']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...
                            contactDetails: {
                                ...prev.contactDetails,
                                permanentAddress: { ...prev.contactDetails.permanentAddress, state: e.target.value }
                            }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    ...
                    {errors['contactDetails.permanentAddress.state'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['contactDetails.permanentAddress.state']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...
                            contactDetails: {
                                ...prev.contactDetails,
                                permanentAddress: { ...prev.contactDetails.permanentAddress, pincode: e.target.value }
                            }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    ...
                    {errors['contactDetails.permanentAddress.pincode'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['contactDetails.permanentAddress.pincode']}</p>
                    )}
                </div>
            </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            courseDetails: { ...prev.courseDetails, selectedCourse: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    >
                    ...
                    {errors['courseDetails.selectedCourse'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['courseDetails.selectedCourse']}</p>
                    )}
                </div>
                ...
                {formData.courseDetails.selectedCourse === 'Other' && (
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setFormData(prev => ({
                                ...prev,
                                courseDetails: { ...prev.courseDetails, customCourse: e.target.value }
                            }))}
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            courseDetails: { ...prev.courseDetails, stream: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            guardianDetails: { ...prev.guardianDetails, guardianName: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        placeholder="Enter guardian name"
                    />
                    {errors['guardianDetails.guardianName'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['guardianDetails.guardianName']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            guardianDetails: { ...prev.guardianDetails, relationship: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    >
                    ...
                    {errors['guardianDetails.relationship'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['guardianDetails.relationship']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            guardianDetails: { ...prev.guardianDetails, guardianPhone: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        placeholder="Enter guardian phone number"
                    />
                    {errors['guardianDetails.guardianPhone'] && (
                        <p className="text-red-500 text-sm mt-1">{errors['guardianDetails.guardianPhone']}</p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => setFormData(prev => ({
                            ...prev,
                            guardianDetails: { ...prev.guardianDetails, guardianEmail: e.target.value }
                        }))}
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
    ...
    const renderReview = () => (
        <div className="space-y-6">
            <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Review & Submit</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 space-y-6">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
                        <div><strong className="text-gray-900 dark:text-white">Name:</strong> {formData.personalDetails.fullName}</div>
                        <div><strong className="text-gray-900 dark:text-white">Father's Name:</strong> {formData.personalDetails.fathersName}</div>
                        <div><strong className="text-gray-900 dark:text-white">Mother's Name:</strong> {formData.personalDetails.mothersName}</div>
                        <div><strong className="text-gray-900 dark:text-white">Date of Birth:</strong> {formData.personalDetails.dateOfBirth}</div>
                        <div><strong className="text-gray-900 dark:text-white">Gender:</strong> {formData.personalDetails.gender}</div>
                        <div><strong className="text-gray-900 dark:text-white">Aadhar:</strong> {formData.personalDetails.aadharNumber}</div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
                        <div><strong className="text-gray-900 dark:text-white">Phone:</strong> {formData.contactDetails.primaryPhone}</div>
                        <div><strong className="text-gray-900 dark:text-white">Email:</strong> {formData.contactDetails.email}</div>
                        <div className="md:col-span-2">
                            <strong className="text-gray-900 dark:text-white">Address:</strong> {formData.contactDetails.permanentAddress.street}, {formData.contactDetails.permanentAddress.city}, {formData.contactDetails.permanentAddress.state} - {formData.contactDetails.permanentAddress.pincode}
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Course Information</h4>
                    <div className="text-sm text-gray-700 dark:text-gray-300">
                        <div><strong className="text-gray-900 dark:text-white">Course:</strong> {formData.courseDetails.selectedCourse}</div>
                        {formData.courseDetails.stream && <div><strong className="text-gray-900 dark:text-white">Stream:</strong> {formData.courseDetails.stream}</div>}
                    </div>
                </div>

                {/* Guardian Information Review */}
                <div>
                    <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Guardian Information</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
                        <div><strong className="text-gray-900 dark:text-white">Name:</strong> {formData.guardianDetails.guardianName}</div>
                        <div><strong className="text-gray-900 dark:text-white">Relationship:</strong> {formData.guardianDetails.relationship}</div>
                        <div><strong className="text-gray-900 dark:text-white">Phone:</strong> {formData.guardianDetails.guardianPhone}</div>
                        {formData.guardianDetails.guardianEmail && <div><strong className="text-gray-900 dark:text-white">Email:</strong> {formData.guardianDetails.guardianEmail}</div>}
                    </div>
                </div>
            ...
            {showTitle && (
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white">
                        {userRole === 'student' ? 'Complete Registration' : 'New Student Registration'}
                    </h2>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">
                        {userRole === 'student'
                    ...
                    {steps.map((step, index) => (
                        <div key={step.id} className="flex items-center">
                            ...
                            {index < steps.length - 1 && (
                                <div className={`hidden sm:block w-16 h-0.5 mx-4 ${currentStep > step.id ? 'bg-purple-600' : 'bg-gray-300'
                                    }`} />
                            )}
                        </div>
                    ))}
