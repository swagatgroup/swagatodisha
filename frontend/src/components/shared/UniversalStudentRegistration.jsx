...
const UniversalStudentRegistration = ({
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent ${user ? 'bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-600 cursor-not-allowed text-gray-500 dark:text-gray-300' : 'border-gray-300 dark:border-gray-600'}`}
        ...
        {formData.courseDetails.selectedCollege && formData.courseDetails.selectedCourse && (() => {
          ...
          return (
            <div className="rounded-2xl overflow-hidden border border-purple-200 dark:border-[#351458] shadow-md">
              ...
              {/* Body */}
              <div className="bg-white dark:bg-[#231A2E] px-5 py-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className={formData.courseDetails.stream ? '' : 'sm:col-span-2'}>
                    ...
                    {isFreeAdm ? (
                      ...
                      <p className="text-2xl font-extrabold text-[#351458] dark:text-[#C084FC]">
  ...
  const renderReview = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 dark:bg-[#231A2E] rounded-lg p-6 space-y-6">
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
            ...
            <div key={step.id} className="flex items-center">
              <div
                className={`flex items-center justify-center w-10 h-10 rounded-full border-2 ${currentStep >= step.id
                  ? "bg-[#4A1D7A] border-[#4A1D7A] text-white"
              ...
              <div className="ml-3 hidden sm:block">
                <p
                  className={`text-sm font-medium ${currentStep >= step.id ? "text-[#4A1D7A]" : "text-gray-500 dark:text-gray-300"
                    }`}
                >
                  {step.title}
                </p>
              ...
              {index < steps.length - 1 && (
                <div
                  className={`hidden sm:block w-16 h-0.5 mx-4 ${currentStep > step.id ? "bg-[#4A1D7A]" : "bg-gray-300"
                    }`}
                />
              )}
            </div>
      ...
      <motion.div
        ...
        className="bg-white dark:bg-[#231A2E] rounded-lg shadow-lg p-6"
      >
        {renderStepContent()}
      </motion.div>
        ...
        <div className="flex space-x-3">
          ...
          {currentStep < steps.length ? (
            <button
              type="button"
              onClick={nextStep}
              className="px-6 py-2 bg-[#4A1D7A] text-white rounded-lg hover:bg-[#351458]"
            >
              Next
            </button>
          ) : (
