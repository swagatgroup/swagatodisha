...
const TermsAndConditions = ({ accepted, onAccept }) => {
    return (
        <div className="space-y-4">
            <div className="max-h-96 overflow-y-auto text-sm text-gray-600 dark:text-gray-300 space-y-4">
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">1. Application Process</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">2. Document Verification</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">3. Fee Structure</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">4. Academic Standards</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">5. Code of Conduct</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">6. Privacy and Data Protection</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">7. Admission Criteria</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">8. Course Modifications</h5>
                    <p>
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 pb-4">
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">9. Refund Policy</h5>
                    <p>
                ...
                <div>
                    <h5 className="font-semibold text-gray-900 dark:text-white mb-2">10. Governing Law</h5>
                    <p>
