...
const EnhancedAgentDashboard = () => {
    ...
    const loadDashboardData = async () => {
        try {
            setLoading(true);
            const [studentsRes, commissionRes, statsRes] = await Promise.all([
                api.get('/api/agents/students'),
                api.get('/api/agents/commission'),
                    ...
                    <>
                        ...
                        >
                            ...
                            <p className="text-blue-100">
                                Manage your students, track commissions, and grow your network.
                            </p>
                        </motion.div>
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900">{stats.pendingStudents}</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900">{stats.completedStudents}</p>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900">{stats.thisMonthRegistrations}</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <motion.div
                            ...
                            className="mb-8"
                        >
                            <CommissionPanel data={commissionData} />
                        </motion.div>
