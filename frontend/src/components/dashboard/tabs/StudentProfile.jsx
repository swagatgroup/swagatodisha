            ...
            >
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-4">
                        <div className="h-20 w-20 bg-[#4A1D7A] rounded-full flex items-center justify-center text-white text-2xl font-bold">
                    ...
                    <div className="flex space-x-3">
                        {editing ? (
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-[#4A1D7A] text-white rounded-lg hover:bg-[#351458]"
                            >
                                Edit Profile
                            </button>
                        )}
