...
const AgentApplicationsTab = ({ applications = [], onRefresh }) => {
    ...
    const getStatusColor = (status) => {
        switch (status) {
            case 'SUBMITTED':
                return 'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 dark:bg-blue-900 dark:text-blue-300';
            case 'UNDER_REVIEW':
                return 'bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-200 dark:bg-yellow-900 dark:text-yellow-300';
            case 'APPROVED':
                return 'bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-200 dark:bg-green-900 dark:text-green-300';
            case 'REJECTED':
                return 'bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-200 dark:bg-red-900 dark:text-red-300';
            case 'DRAFT':
                return 'bg-gray-100 dark:bg-gray-800/60 text-gray-800 dark:text-gray-200 dark:bg-[#1A1212] dark:text-gray-300';
            default:
                return 'bg-gray-100 dark:bg-gray-800/60 text-gray-800 dark:text-gray-200 dark:bg-[#1A1212] dark:text-gray-300';
        }
    };
                ...
                <div className="p-4 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <span className={`px-2 py-1 rounded-full text-xs font-medium ${application.reviewStatus.overallDocumentReviewStatus === 'ALL_APPROVED'
                                    ...
                                    : application.reviewStatus.overallDocumentReviewStatus === 'ALL_REJECTED'
                                        ...
                                        : application.reviewStatus.overallDocumentReviewStatus === 'PARTIALLY_APPROVED'
                                            ? 'bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-200 dark:bg-yellow-900 dark:text-yellow-200'
                                            : 'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 dark:bg-blue-900 dark:text-blue-200'
                                    }`}>
                    ...
                    <div className="flex items-center justify-between mt-3">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button className="p-1 text-gray-400 dark:text-gray-300 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-300">
                                <svg
                                        ...
                                        {application.documents.map((doc, index) => (
                                            <div key={index} className="flex items-center justify-between p-2 bg-white dark:bg-gray-600 rounded border">
                                                ...
                                                <span className={`px-2 py-1 rounded-full text-xs font-medium ${doc.status === 'APPROVED'
                                                        ...
                                                        : doc.status === 'REJECTED'
                                                            ? 'bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-200 dark:bg-red-900 dark:text-red-200'
                                                            : 'bg-gray-100 dark:bg-gray-800/60 text-gray-800 dark:text-gray-200 dark:bg-[#1A1212] dark:text-gray-200'
                                                    }`}>
                                                    {doc.status}
                                                </span>
                                            </div>
                    ...
                    <div className="flex-1">
                        <div className="relative">
                            ...
                            {searchQuery && (
                                ...
                                >
                                    <svg className="h-5 w-5 text-gray-400 dark:text-gray-300 hover:text-gray-600 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
