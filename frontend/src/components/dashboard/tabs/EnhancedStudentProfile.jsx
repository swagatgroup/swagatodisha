        ...
        <div className="space-y-6">
            ...
            >
                <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-sm font-medium text-[#4A1D7A]">{completionPercentage}% Complete</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['personalDetails.fullName'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['personalDetails.fathersName'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['personalDetails.mothersName'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['personalDetails.dateOfBirth'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                        />
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['personalDetails.gender'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['personalDetails.aadharNumber'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['contactDetails.primaryPhone'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['contactDetails.email'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['courseDetails.selectedCourse'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['guardianDetails.guardianName'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['guardianDetails.relationship'] ? 'border-red-500' : 'border-gray-300'
                                }`}
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors['guardianDetails.guardianPhone'] ? 'border-red-500' : 'border-gray-300'
                                }`}
