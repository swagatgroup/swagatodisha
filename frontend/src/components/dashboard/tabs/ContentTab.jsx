        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <div className="space-y-2">
                    {formData.about.features.map((feature, index) => (
                        <div key={index} className="flex items-center space-x-2">
                            <input
                                ...
                                className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent"
                            />
                            <button
                    ...
                    <button
                        onClick={addFeature}
                        className="px-4 py-2 text-[#4A1D7A] hover:text-purple-800 text-sm font-medium"
                    >
                        + Add Feature
                    </button>
                </div>
