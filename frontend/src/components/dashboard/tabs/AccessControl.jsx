...
const AccessControl = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8">
            <div className="bg-white dark:bg-[#231A2E] rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#231A2E]/50">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                />
                                <div className="w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 dark:peer-focus:ring-indigo-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white dark:bg-[#231A2E] after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-[#4A1D7A]"></div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {!settings.showReferralRewardTier && (
                            ...
                            >
                                ...
                                <textarea
                                    className="w-full px-4 py-2 bg-white dark:bg-[#1A1212] border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#4A1D7A] dark:text-white"
                                    rows="3"
                ...
                <div className="p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#231A2E]/50 flex justify-end">
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className={`px-6 py-2 bg-[#4A1D7A] hover:bg-[#351458] text-white rounded-lg font-medium shadow-sm transition-colors ${saving ? 'opacity-75 cursor-not-allowed' : ''}`}
                    >
                        {saving ? (
