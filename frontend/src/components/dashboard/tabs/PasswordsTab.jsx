            ...
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div className="relative">
                    <input
                        ...
                        className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                    />
                            ...
                            <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <button
                                        ...
                                        className="text-[#4A1D7A] hover:text-purple-900 dark:text-[#9B6FCC] dark:hover:text-purple-300 font-medium"
                                    >
                                        Reset Password
                                    </button>
                                </td>
        ...
        <div className="space-y-6">
            ...
            {selectedUser && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
                    <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-[#231A2E] border-gray-200 dark:border-gray-700">
                        <div className="mt-3">
                            <div className="flex items-center justify-center w-12 h-12 mx-auto bg-[#F0E6FA] rounded-full">
                                <svg className="w-6 h-6 text-[#4A1D7A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center justify-end px-4 py-3 bg-gray-50 dark:bg-gray-700 sm:px-6">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium text-white bg-[#4A1D7A] border border-transparent rounded-md hover:bg-[#351458] disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Reset Password
                                </button>
                            </div>
