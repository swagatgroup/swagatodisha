...
const AgentStudentsTab = () => {
    ...
    const loadStats = async () => {
        try {
            const response = await api.get('/api/agents/student-stats');
            if (response.data.success) {
    ...
    const filteredStudents = students.filter(student => {
        const matchesSearch = !filters.search ||
            student.personalDetails?.fullName?.toLowerCase().includes(filters.search.toLowerCase()) ||
        ...
        const matchesCourse = !filters.course || student.courseDetails?.selectedCourse === filters.course;
                                ...
                                >
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <div className="text-sm text-gray-500 dark:text-gray-400">
                                                    Aadhaar: {student.personalDetails?.aadharNumber || 'N/A'}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div className="flex space-x-2">
                                            <button
                                                onClick={() => {/* TODO: Implement view student functionality */ }}
                                                className="text-blue-600 hover:text-blue-900"
                                            >
                                                View
                                            </button>
                                            <button
                                                onClick={() => {/* TODO: Implement edit student functionality */ }}
