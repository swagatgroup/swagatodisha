...
return (
    <div className="space-y-6 dark:text-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-[#2A1E2E] dark:border dark:border-gray-700 p-6 rounded-lg shadow">
            ...
            <div className="bg-white dark:bg-[#2A1E2E] dark:border dark:border-gray-700 p-6 rounded-lg shadow">
                <div className="flex items-center">
                    <div className="p-2 bg-[#EDE0F7] rounded-lg">
                        <svg className="h-6 w-6 text-[#7B3FA0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white dark:bg-[#2A1E2E] dark:border dark:border-gray-700 rounded-lg shadow">
            ...
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    <select
                        ...
                        className="px-3 py-2 border border-gray-300 dark:border-gray-700 dark:bg-[#1A1212] dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-[#7B3FA0] focus:border-transparent"
                    >
                        <option>All</option>
                                ...
                                <tr key={agent._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div className="flex space-x-2">
                                            <button className="text-[#7B3FA0] hover:text-indigo-400" title="Edit">
