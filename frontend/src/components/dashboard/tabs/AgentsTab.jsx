    ...
    <div className="space-y-6 dark:text-gray-100">
        ...
        <div className="flex items-center justify-between">
            ...
            <button
                ...
                className="px-4 py-2 bg-[#4A1D7A] text-white rounded-lg hover:bg-[#351458] transition-colors duration-200 flex items-center"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-[#231A2E] dark:border dark:border-gray-700 p-6 rounded-lg shadow">
            ...
            <div className="bg-white dark:bg-[#231A2E] dark:border dark:border-gray-700 p-6 rounded-lg shadow">
                <div className="flex items-center">
                    <div className="p-2 bg-[#F0E6FA] rounded-lg">
                        <svg className="h-6 w-6 text-[#4A1D7A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white dark:bg-[#231A2E] dark:border dark:border-gray-700 rounded-lg shadow">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Agents Information</h3>
            </div>
            ...
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    <div className="relative">
                        <input
                            ...
                            className="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 dark:bg-[#1A1212] dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent"
                        />
                ...
                <div className="flex items-center space-x-4">
                    <select
                        ...
                        className="px-3 py-2 border border-gray-300 dark:border-gray-700 dark:bg-[#1A1212] dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent"
                    >
                        <option>All</option>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="bg-white dark:bg-[#231A2E] divide-y divide-gray-200 dark:divide-gray-700">
                        {loading ? (
                            ...
                            agents.map((agent) => (
                                <tr key={agent._id} className="hover:bg-gray-50 dark:bg-[#1A1212] dark:hover:bg-gray-700">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div className="flex space-x-2">
                                            <button className="text-[#4A1D7A] hover:text-indigo-400" title="Edit">
