            ...
            <div className="bg-white rounded-lg shadow">
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="relative">
                            <input
                                ...
                                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent"
                            />
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex space-x-2">
                                                <button
                                                    ...
                                                    className="text-[#4A1D7A] hover:text-indigo-900"
                                                    title="Edit"
                                                >
                ...
                <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <button className="px-3 py-1 text-sm bg-[#4A1D7A] text-white rounded">1</button>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent"
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-end space-x-3 pt-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="px-4 py-2 text-sm font-medium text-white bg-[#4A1D7A] border border-transparent rounded-md hover:bg-[#351458]"
                                    >
