    ...
    const renderSidebarContent = () => {
        switch (activeSidebarItem) {
                ...
                return (
                    <div className="bg-white rounded-lg shadow p-6">
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 mb-4">This feature is coming soon! You'll be able to view and manage all your applications here.</p>
            ...
            case 'payments':
                return (
                    <div className="bg-white rounded-lg shadow p-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">My Payments</h3>
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 mb-4">This feature is coming soon! You'll be able to view and manage your payments here.</p>
