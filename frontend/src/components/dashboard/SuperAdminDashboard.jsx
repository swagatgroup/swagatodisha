        ...
        switch (activeSidebarItem) {
                                                            ...
                                                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                                <div className="flex space-x-2">
                                                                    <button
                                                                        ...
                                                                        className="text-[#387B95] hover:text-blue-900 dark:text-[#60A5FA] dark:hover:text-blue-300 cursor-pointer"
                                                                        title="View Details"
                                                                    >
            ...
            case 'direct-students':
                return (
                    <div className="dark:text-gray-100">
                        <ErrorBoundary>
                            <StudentManagement initialFilter={studentTableFilter} listType="direct" />
                        </ErrorBoundary>
                    </div>
                );
            case 'agents':
            ...
            case 'application-review':
                return <ApplicationReview userRole="super_admin" />;
