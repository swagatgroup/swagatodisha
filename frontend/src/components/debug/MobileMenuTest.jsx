                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center">
                            <button
                                ...
                                className="lg:hidden p-2 rounded-md text-gray-400 dark:text-gray-300 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#4A1D7A]"
                            >
                            ...
                            <div className="flex items-center lg:ml-0">
                                <div className="flex items-center">
                                    <div className="h-10 w-10 bg-[#4A1D7A] rounded-lg flex items-center justify-center">
