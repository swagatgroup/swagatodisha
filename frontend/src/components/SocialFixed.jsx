            ...
            <ul>
                <li className="list-none">
                    <a
                        ...
                        target="_blank"
                        className="flex justify-between items-center p-1 py-0 text-decoration-none bg-white dark:bg-[#231A2E] text-[#4c4cc8] w-full border-b border-black relative right-[-5.3rem] transition-right duration-300 ease-in-out hover:right-0"
                    >
