                        ...
                        <div className="flex items-center">
                            {[1, 2, 3].map((step) => (
                                <div key={step} className="flex items-center">
                                    ...
                                    {step < 3 && (
                                        <div
                                            className={`w-16 h-1 mx-2 ${step < currentStep ? "bg-[#4A1D7A]" : "bg-gray-200"
                                                }`}
                                        />
                                    )}
                                </div>
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex space-x-3">
                            ...
                            {currentStep < 3 ? (
                                <button
                                    onClick={handleNext}
                                    className="px-4 py-2 text-sm font-medium text-white bg-[#4A1D7A] rounded-md hover:bg-[#351458]"
                                >
                                    Next
                                </button>
                            ) : (
                                <button
                                    ...
                                    disabled={loading}
                                    className="px-4 py-2 text-sm font-medium text-white bg-[#4A1D7A] rounded-md hover:bg-[#351458] disabled:opacity-50"
                                >
