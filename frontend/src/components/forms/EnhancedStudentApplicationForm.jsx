...
const EnhancedStudentApplicationForm = ({ onClose, onSuccess }) => {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.firstName ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.lastName ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.email ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.phone ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.dateOfBirth ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                                />
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.gender ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.fatherName ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.address ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.city ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.state ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.pincode ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <select
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.course ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                                >
                            ...
                            <div className="md:col-span-2">
                                ...
                                <select
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.institution ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.preferredStartDate ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.previousQualification ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.previousInstitution ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.previousYear ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] ${errors.previousPercentage ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                                        } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
            ...
            case 4:
                return (
                    <div className="space-y-6">
                        ...
                        {/* Application Summary */}
                        <div className="bg-gray-50 dark:bg-[#231A2E] rounded-lg p-6 space-y-4">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start space-x-3">
                                <input
                                    ...
                                    className="mt-1 h-4 w-4 text-[#4A1D7A] focus:ring-[#4A1D7A] border-gray-300 rounded"
                                />
                                <label htmlFor="termsAccepted" className="text-sm text-gray-700 dark:text-gray-300">
                                    I have read and agree to the{' '}
                                    <button
                                        type="button"
                                        className="text-[#4A1D7A] hover:text-purple-800 underline"
                ...
                return (
                    <div className="text-center space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                onClick={generatePDF}
                                className="px-6 py-2 bg-[#4A1D7A] text-white rounded-lg hover:bg-[#351458] transition-colors duration-200"
                            >
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-[#231A2E] rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                {/* Header */}
                <div className="sticky top-0 bg-white dark:bg-[#231A2E] border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                            ...
                            {steps.map((step) => (
                                <div key={step.number} className="flex items-center">
                                    ...
                                    {step.number < totalSteps && (
                                        <div className={`w-16 h-1 mx-2 ${currentStep > step.number ? 'bg-[#4A1D7A]' : 'bg-gray-300 dark:bg-gray-600'
                                            }`} />
                                    )}
                                </div>
                            ))}
                ...
                {/* Footer */}
                {currentStep < 5 && (
                    <div className="sticky bottom-0 bg-white dark:bg-[#231A2E] border-t border-gray-200 dark:border-gray-700 px-6 py-4">
                        <div className="flex justify-between">
                            <div className="flex space-x-3">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 text-[#4A1D7A] border border-[#4A1D7A] rounded-lg hover:bg-[#F0E6FA] dark:hover:bg-purple-900/20 transition-colors duration-200 disabled:opacity-50"
                                >
