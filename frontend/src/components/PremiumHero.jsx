        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div className="space-y-8" ref={textRef}>
            ...
            <div className="space-y-4">
              ...
              >
                Welcome to{' '}
                <span className="text-[#4A1D7A] dark:text-[#9B6FCC]">
                  Swagat
                </span>
              </motion.h1>
            ...
            {/* Description */}
            <motion.p
              className="text-xl text-[#5A5A5A] dark:text-[#B8A8C8] leading-relaxed max-w-lg font-lato"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <motion.div
                className="text-center bg-white dark:bg-[#231A2E] py-4 rounded-2xl shadow-card border border-[#4A1D7A]/10"
                whileHover={{ scale: 1.05 }}
                transition={{ type: "spring", stiffness: 300 }}
              >
                <div className="text-3xl font-bold font-baloo text-[#E8A817]">5000+</div>
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <div className="text-3xl font-bold font-baloo text-[#4A1D7A] dark:text-[#9B6FCC]">95%</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              ...
              <motion.button
                className="hero-cta px-8 py-4 border-2 border-[#4A1D7A] dark:border-[#9B6FCC] text-[#4A1D7A] dark:text-[#9B6FCC] font-bold rounded-pill text-lg hover:bg-[#4A1D7A] dark:hover:bg-[#9B6FCC] hover:text-white transition-all duration-300 hover:scale-105 bg-white/50 dark:bg-transparent backdrop-blur-sm"
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                Contact Us
          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            <div className="absolute inset-0 bg-[#F0E6FA] dark:bg-[#3D2A4A]/30 rounded-full blur-[80px] opacity-60"></div>
            ...
            <div className="relative w-80 h-80 flex items-center justify-center z-10">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-transparent pointer-events-none">
                <div className="text-center text-[#4A1D7A] dark:text-[#9B6FCC]">
                  <div className="w-12 h-12 border-4 border-[#4A1D7A]/30 border-t-[#4A1D7A] rounded-full animate-spin mx-auto mb-3"></div>
            ...
            <motion.div
              className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-white dark:bg-[#231A2E] shadow-card rounded-pill px-6 py-3 text-[#1A1A1A] dark:text-[#FAF7F2] text-center border border-[#4A1D7A]/10 z-20"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <div className="absolute bottom-[-0.25rem] left-0 w-full z-20">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-[60px] md:h-[120px]">
          <path
            ...
            className="fill-white dark:fill-[#231A2E]"
          ></path>
        </svg>
      </div>
    </section>
