...
class ErrorBoundary extends React.Component {
    ...
    render() {
        if (this.state.hasError) {
            // Fallback UI
            return (
                <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#1A1212]">
                    <div className="max-w-md w-full bg-white dark:bg-[#2A1E2E] shadow-lg rounded-lg p-6">
                        ...
                        <div className="flex space-x-3">
                            <button
                                ...
                                className="flex-1 bg-[#7B3FA0] text-white px-4 py-2 rounded-md hover:bg-[#5C2D80] focus:outline-none focus:ring-2 focus:ring-[#7B3FA0]"
                            >
                                Refresh Page
                            </button>
                            <button
