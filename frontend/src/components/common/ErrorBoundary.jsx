        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#1A1212]">
                    <div className="max-w-md w-full bg-white dark:bg-[#231A2E] shadow-lg rounded-lg p-6">
                        ...
                        <div className="flex space-x-3">
                            <button
                                ...
                                className="flex-1 bg-[#4A1D7A] text-white px-4 py-2 rounded-md hover:bg-[#351458] focus:outline-none focus:ring-2 focus:ring-[#4A1D7A]"
                            >
                                Refresh Page
                            </button>
                            <button
