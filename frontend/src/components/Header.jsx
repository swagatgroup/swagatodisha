        ...
        >
          ...
          >
            ...
            <div className="hidden lg:flex items-center space-x-3">
              ...
              <Link
                to="/register"
                className="flex items-center gap-1.5 px-5 py-2 bg-[#4A1D7A] text-white rounded-full font-bold text-sm shadow-brand hover:bg-[#351458] transition-all duration-200"
              >
            ...
            >
              ...
              <div className="px-5 pb-8 pt-4 border-t border-[#4A1D7A]/10 dark:border-[#9B6FCC]/15 space-y-3">
                ...
                <Link
                  to="/register"
                  onClick={() => setIsNavOpen(false)}
                  className="flex items-center justify-center gap-2 py-3 bg-[#4A1D7A] text-white rounded-full font-bold shadow-brand hover:bg-[#351458] transition"
                >
