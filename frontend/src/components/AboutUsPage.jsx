...
const AboutUsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
            ...
            {/* Hero Section */}
            <section className="relative py-20 overflow-hidden dark:bg-gray-800 ">
                ...
                <div className="relative z-10 container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl text-gray-600 max-w-4xl mx-auto dark:text-gray-300 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
                        {values.map((value, index) => (
                            <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-bold dark:text-gray-100 text-gray-800 mb-3 text-center">{value.title}</h3>
                                <p className="text-gray-600 dark:text-gray-400 text-center text-sm leading-relaxed">{value.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-20 bg-white dark:bg-gray-900">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl dark:text-gray-100 md:text-5xl font-bold text-gray-800 mb-6">
                                    ...
                                    <div key={index} className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                                        <div className="w-1/2 px-8">
                                            <div className={`bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 ${index % 2 === 0 ? 'text-right' : 'text-left'}`}>
                                                ...
                                                <p className="text-gray-600 dark:text-gray-100 text-sm leading-relaxed">{milestone.description}</p>
                                            </div>
                                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {team.map((member, index) => (
                            <div key={index} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                                ...
                                <p className="text-gray-600 text-center dark:text-gray-100 text-sm leading-relaxed">{member.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h2 className="text-4xl md:text-5xl dark:text-gray-100 font-bold text-gray-800 mb-6">
                                ...
                                <div className="space-y-6 ">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold dark:text-gray-200 text-gray-800 mb-2">Quality Education</h3>
                                            <p className="text-gray-600 dark:text-gray-400">We provide world-class education with modern curriculum and experienced faculty.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h3 className="text-xl dark:text-gray-200 font-bold text-gray-800 mb-2">Personal Attention</h3>
                                            <p className="text-gray-600 dark:text-gray-400">Small class sizes ensure individual attention and personalized learning experiences.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h3 className="text-xl dark:text-gray-200 font-bold text-gray-800 mb-2">Modern Facilities</h3>
                                            <p className="text-gray-600 dark:text-gray-400">State-of-the-art infrastructure with latest technology and learning resources.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-gradient-to-br  from-purple-50 to-blue-50 rounded-3xl p-8 border border-purple-100">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                        ...
                                        <div>
                                            <h5 className="font-semibold dark:text-gray-200 text-gray-800">Multiple Awards</h5>
                                    ...
                                    <div className="flex items-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                        ...
                                        <div>
                                            <h5 className="font-semibold dark:text-gray-200 text-gray-800">1000+ Students</h5>
                                    ...
                                    <div className="flex items-center p-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                        ...
                                        <div>
                                            <h5 className="font-semibold dark:text-gray-200 text-gray-800">High Satisfaction</h5>
