    ...
    return (
        <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    <motion.div
                        className="inline-flex items-center gap-2 bg-[#4A1D7A] text-white px-6 py-3 rounded-full text-sm font-semibold mb-6"
                    ...
                    <h2 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-6">
                        Our <span className="bg-[#4A1D7A] bg-clip-text text-transparent">
                            Premium Programs
                        </span>
                    </h2>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative z-10 flex-1 flex flex-col">
                                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-1 group-hover:text-[#4A1D7A] transition-colors duration-300">
                                        {program.title}
                                    </h3>
                                    <p className="text-[#4A1D7A] font-semibold mb-3 text-sm">
                                        {program.subtitle}
                                    </p>
                ...
                >
                    <motion.button
                        className="px-10 py-4 bg-[#4A1D7A] text-white rounded-full text-lg font-semibold shadow-2xl hover:shadow-purple-500/25 transition-all duration-300"
