...
const StudentPasswordReset = () => {
        ...
        Swal.fire({
            ...
            html: `
                <div class="text-center mt-2 mb-6">
                    <p class="text-sm text-gray-600 dark:text-gray-300">Please enter the new password for <span class="font-semibold text-[#4A1D7A] dark:text-[#9B6FCC]">${student.personalDetails?.fullName || student.fullName || 'Student'}</span>'s account.</p>
                </div>
                <div class="relative w-full mx-auto group">
                 <input type="password" id="new-password-input"
                        ...
                        class="w-full px-4 py-3 pr-12 text-sm border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#4A1D7A] focus:border-transparent transition-all duration-300 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400" 
                        placeholder="New Password (min. 6 chars)">
                    <button type="button" id="toggle-password" 
                        class="absolute inset-y-0 right-0 px-4 flex items-center text-gray-400 hover:text-[#4A1D7A] transition-colors duration-200 focus:outline-none">
            ...
            customClass: {
                popup: 'rounded-2xl shadow-xl dark:bg-[#231A2E] dark:border-gray-700',
                title: 'p-0 text-center',
                htmlContainer: 'text-center m-0',
                confirmButton: 'px-5 py-2.5 bg-[#4A1D7A] hover:bg-[#351458] text-white text-sm font-medium rounded-xl transition-colors shadow-sm mx-1',
    ...
    const getRegisteredByLabel = (student) => {
        ...
        const roleMeta = {
            ...
            staff: {
                label: 'Staff',
                color: 'bg-[#F0E6FA] text-purple-800 dark:bg-[#231A2E]/30 dark:text-[#9B6FCC]'
            },
            super_admin: {
                label: 'Admin',
    ...
    return (
        <div className="bg-white dark:bg-[#231A2E] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-[#231A2E]/50">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
                    <div className="w-full sm:w-1/3">
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md leading-5 bg-white dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#4A1D7A] focus:border-indigo-500 sm:text-sm text-gray-900 dark:text-white"
                    ...
                    <div className="w-full sm:w-1/4">
                        <select
                            ...
                            className="block w-full pl-3 pr-10 py-2 text-base border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-[#4A1D7A] focus:border-indigo-500 sm:text-sm rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white cursor-pointer"
                        >
                                    ...
                                    <tr key={student._id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                <div className="h-10 w-10 flex-shrink-0 rounded-full bg-indigo-100 dark:bg-[#231A2E] flex items-center justify-center">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button
                                                ...
                                                className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-indigo-200 dark:border-indigo-800 text-[#351458] dark:text-[#9B6FCC] hover:bg-[#F0E6FA] dark:hover:bg-indigo-900/30 rounded-md transition-colors"
                                            >
                    ...
                    <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-700 px-4 py-3 sm:px-6 mt-4">
                        <div className="flex flex-1 justify-between sm:hidden">
                            <button
                                ...
                                className="relative inline-flex items-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#231A2E] px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50"
                            >
                                Previous
                            </button>
                            <button
                                ...
                                className="relative ml-3 inline-flex items-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#231A2E] px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50"
                            >
                                Next
                            </button>
                        </div>
