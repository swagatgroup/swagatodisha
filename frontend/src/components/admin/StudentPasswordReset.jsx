...
const StudentPasswordReset = () => {
    ...
    }, [currentPage, debouncedSearchTerm, selectedSession]);
    ...
    const handleResetPasswordClick = (student) => {
        Swal.fire({
            ...
            html: `
                ...
                <input type="password" id="new-password-input" class="swal2-input !mt-0 !w-full !box-border" placeholder="New Password (min 6 characters)">
            `,
            icon: 'warning',
