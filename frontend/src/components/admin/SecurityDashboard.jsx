...
const SecurityDashboard = () => {
    ...
    const getPriorityColor = (priority) => {
        switch (priority) {
            ...
            case 'LOW': return 'text-[#387B95] bg-blue-100';
    ...
    if (!securityReport) {
        return (
            <div className="text-center py-8">
                <p className="text-gray-500 dark:text-gray-300">Failed to load security report</p>
            </div>
        );
    }
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">Monitor and manage system security</p>
                    </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Overall Security Score</h3>
                ...
                <div className="p-6">
                    ...
                    {activeTab === 'overview' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="bg-gray-50 rounded-lg p-4">
                                <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Password Security</h4>
                                <p className="text-2xl font-bold text-red-600">
                                    {securityReport.audits.passwords.weakPasswords}
                                </p>
                                <p className="text-sm text-gray-600 dark:text-gray-300">Weak passwords detected</p>
                            </div>
                            <div className="bg-gray-50 rounded-lg p-4">
                                <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">JWT Security</h4>
                                <p className="text-2xl font-bold text-green-600">
                                    {securityReport.audits.jwt.isStrongSecret ? '✓' : '✗'}
                                </p>
                                <p className="text-sm text-gray-600 dark:text-gray-300">Strong secret configured</p>
                            </div>
                            <div className="bg-gray-50 rounded-lg p-4">
                                <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Database Security</h4>
                                <p className="text-2xl font-bold text-yellow-600">
                                    {securityReport.audits.database.hasIndexes ? '✓' : '✗'}
                                </p>
                                <p className="text-sm text-gray-600 dark:text-gray-300">Indexes configured</p>
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 'passwords' && (
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Password Security Audit</h4>
                            ...
                            {securityReport.audits.passwords.weakPasswordDetails.length > 0 && (
                                <div>
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">Users with Weak Passwords</h5>
                    ...
                    {activeTab === 'jwt' && (
                        <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">JWT Security Configuration</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Secret Configured</h5>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Secret Length</h5>
                                    <p className="text-lg font-bold text-gray-600 dark:text-gray-300">
                                        {securityReport.audits.jwt.secretLength} characters
                                    </p>
                                </div>
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Strong Secret</h5>
                    ...
                    {activeTab === 'database' && (
                        <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Database Security</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Total Users</h5>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Indexes Configured</h5>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Encrypted Connection</h5>
                    ...
                    {activeTab === 'files' && (
                        <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">File Upload Security</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Allowed MIME Types</h5>
                                    <p className="text-2xl font-bold text-[#387B95]">
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Max File Size</h5>
                                    <p className="text-2xl font-bold text-green-600">
                                        {securityReport.audits.fileUploads.maxFileSize}
                                    </p>
                                </div>
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">File Validation</h5>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100">Virus Scanning</h5>
                    ...
                    {activeTab === 'recommendations' && (
                        <div className="space-y-4">
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Security Recommendations</h4>
                            {securityReport.recommendations.length === 0 ? (
                                <div className="text-center py-8">
                                    <div className="text-green-600 text-6xl mb-4">✓</div>
                                    <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">All security checks passed!</p>
                                            ...
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    <div className="flex items-center space-x-3 mb-2">
                                                        ...
                                                        <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{rec.category}</span>
                                                    </div>
                                                    <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">{rec.issue}</h5>
                                                    <p className="text-gray-600 dark:text-gray-300">{rec.recommendation}</p>
                                                </div>
                                            </div>
                                        </motion.div>
                                    ))}
