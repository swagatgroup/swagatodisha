            ...
            <div className="relative z-10 pb-12">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <h2 className="text-5xl md:text-7xl font-bold text-gray-800 dark:text-gray-100 mb-6">
                        Our <span className="text-transparent bg-clip-text bg-[#4A1D7A]">Location</span>
                    </h2>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        <div className="w-10 h-10 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                                            <i className="fa-solid fa-map-marker-alt text-[#4A1D7A] text-lg"></i>
                                        </div>
                                    ...
                                    <div className="flex items-start">
                                        <div className="w-10 h-10 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                                            <i className="fa-solid fa-phone text-[#4A1D7A] text-lg"></i>
                                        </div>
                                        <div className='text-left'>
                                    ...
                                    <div className="flex items-start">
                                        <div className="w-10 h-10 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                                            <i className="fa-solid fa-envelope text-[#4A1D7A] text-lg"></i>
                                        </div>
                                        <div className='text-left'>
                    ...
                    <div key={index} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center">
                                <i className="fa-solid fa-map-marker-alt text-[#4A1D7A] mr-3"></i>
                                <span className="text-gray-700 dark:text-gray-200">{location.address}</span>
                            </div>
                            <div className="flex items-center">
                                <i className="fa-solid fa-phone text-[#4A1D7A] mr-3"></i>
                                <span className="text-gray-700 dark:text-gray-200">{location.phone}</span>
                            </div>
                            <div className="flex items-center">
                                <i className="fa-solid fa-envelope text-[#4A1D7A] mr-3"></i>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    <div className="w-8 h-8 bg-[#4A1D7A] rounded-lg flex items-center justify-center mr-4 flex-shrink-0 mt-1">
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-3xl p-8 border border-purple-100">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center p-4 bg-white rounded-xl shadow-sm">
                                    <i className="fa-solid fa-bus text-[#4A1D7A] text-xl mr-4"></i>
                                    <div>
