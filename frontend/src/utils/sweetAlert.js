...
const defaultConfig = {
    ...
    padding: '2rem',
    customClass: {
        popup: 'rounded-lg shadow-xl bg-white dark:bg-[#2A1E2E] border border-gray-200 dark:border-gray-700',
        title: 'text-xl font-semibold text-gray-900 dark:text-gray-100',
        content: 'text-gray-700 dark:text-gray-300',
        confirmButton: 'px-6 py-2 rounded-md font-medium transition-colors duration-200 bg-[#7B3FA0] hover:bg-[#5C2D80] text-white',
    ...
    return Swal.fire({
        ...
        html: `
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5 mb-4">
                <div id="progress-bar" class="bg-[#7B3FA0] h-2.5 rounded-full transition-all duration-300" style="width: 0%"></div>
            </div>
